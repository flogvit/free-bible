...
const fpArg = args.indexOf('--fingerprints');
if (fpArg < 0) { console.error('Mangler --fingerprints <fil>'); process.exit(1); }
const dryRun = args.includes('--dry-run');
const fps: Record<string, Record<string, number[] | null>> = JSON.parse(readFileSync(args[fpArg + 1], 'utf8'));
