 ...
 *
 * Usage:
 *   bun scripts/build-mapping.ts --bible dnb2011_nb --format txt
 *   bun scripts/build-mapping.ts --bible english_kj --format raw
 *   bun scripts/build-mapping.ts --bible dnb2011_nb --format txt --chapter 19:3
 *   bun scripts/build-mapping.ts --bible dnb2011_nb --format txt --dry-run
 *   bun scripts/build-mapping.ts --bible dnb2011_nb --format txt --model gemma4:31b
 *
...
const HELP_EXAMPLES = [
  'bun kvn/scripts/build-mapping.ts --bible dnb2011_nb --format txt',
  'bun kvn/scripts/build-mapping.ts --bible english_kj --format raw',
  'bun kvn/scripts/build-mapping.ts --bible dnb2011_nb --format txt --chapter 19:3',
  'bun kvn/scripts/build-mapping.ts --bible dnb2011_nb --format txt --dry-run',
  'bun kvn/scripts/build-mapping.ts --bible osnb --format raw --fast --no-verify',
];
