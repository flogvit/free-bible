...
// den er det som gjør at `--help` svarer i stedet for å lese 38 bibler fra
// disk, og at et ukjent flagg feiler høyt framfor å bli ignorert.
const SPEC: Record<string, FlagSpec> = {
  help: COMMON_FLAGS.help,
};

const HELP_EXAMPLES = [
  'bun kvn/scripts/analyze-sentence-splits.ts',
];
...
function main(): void {
  ...
  if (flags.help) {
    console.log(formatHelp(
      ...
      'måler om versdelinger mellom oversettelser faller på setningsgrenser, og hvor mange setninger et vers har',
      SPEC,
      HELP_EXAMPLES,
    ));
    process.exit(0);
