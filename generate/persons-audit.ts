...
//
// Usage: bun persons-audit.ts <proposals.json>
...
const HELP_EXAMPLES = [
    'bun generate/persons-audit.ts proposals.json',
];
...
if (!PROP) { console.error('usage: bun generate/persons-audit.ts <proposals.json>'); process.exit(1); }
...
/** Hvor sikker LLM-en var. Verdiene er enum-en i `SCHEMA` i persons-reconcile.ts. */
...
/**
 * Ett forslag slik persons-reconcile.ts skriver det til proposals.json.
 *
