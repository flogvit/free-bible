...
//
// Usage: bun persons-integrity.ts --help
//
...
const HELP_EXAMPLES = [
    'bun generate/persons-integrity.ts                     # sammendrag, exit 1 hvis noe er uløst',
    'bun generate/persons-integrity.ts --verbose           # hvert avvik og hver uløst referanse',
    'bun generate/persons-integrity.ts --worklist out.json # arbeidslista persons-reconcile.ts leser',
];
