...
const HELP_EXAMPLES = [
    'bun generate/number-symbolism.ts --number 7                       # symbolikken for 7',
    'bun generate/number-symbolism.ts --number 7 --bible osnb          # med skann av oversettelsen',
    'bun generate/number-symbolism.ts --number 7 --bible osnb --scan   # bare skann, ingen modell',
    'bun generate/number-symbolism.ts --all --proofread --apply        # generer → korrektur → skriv inn',
    'bun generate/number-symbolism.ts --number 7 --proofread --apply --min-score 9',
    'bun generate/number-symbolism.ts --number 3 --force               # generer 3 på nytt',
    'bun generate/number-symbolism.ts --bible osnb --index --local     # indekser hele bibelen lokalt',
    '',
