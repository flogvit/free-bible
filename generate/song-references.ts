 ...
 *
 * Usage:
 *   bun generate/song-references.ts                       # Process all songs
 *   bun generate/song-references.ts --language nb         # Only Norwegian bokmål
 *   bun generate/song-references.ts --language en         # Only English
 *   bun generate/song-references.ts --id song-0217        # Process one specific song
 *   bun generate/song-references.ts --limit 50            # Process max 50 songs
 *   bun generate/song-references.ts --model gemma4:31b    # Use specific model
 *   bun generate/song-references.ts --force               # Re-process even if result exists
 */
...
const HELP_EXAMPLES = [
    'bun generate/song-references.ts                     # alle sanger som mangler resultat',
    'bun generate/song-references.ts --language nb       # bare norsk bokmål',
    'bun generate/song-references.ts --id song-0217      # én sang',
    'bun generate/song-references.ts --limit 50          # maks 50 sanger',
    'bun generate/song-references.ts --model gemma4:31b  # pinn modellen',
    '',
