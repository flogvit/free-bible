...
//
// Usage:
//   bun persons-apply-reconcile.ts <map.json> [--dry-run]
...
const HELP_EXAMPLES = [
    'bun generate/persons-apply-reconcile.ts map.json --dry-run   # vis hva som ville blitt endret',
    'bun generate/persons-apply-reconcile.ts map.json             # skriv endringene',
];
...
if (!MAP_PATH) { console.error('usage: bun generate/persons-apply-reconcile.ts <map.json> [--dry-run]'); process.exit(1); }
