...
const HELP_EXAMPLES = [
    'bun generate/scan-stories.ts                                    # skann alle fortellende bøker',
    'bun generate/scan-stories.ts --book 1 --chapter 12              # bare 1. Mosebok 12',
    'bun generate/scan-stories.ts --proofread --apply                # korrektur på forslagene',
    'bun generate/scan-stories.ts --proofread --pool existing --apply',
    'bun generate/scan-stories.ts --proofread --pool both --apply',
    'bun generate/scan-stories.ts --proofread --apply --continue     # fortsett en avbrutt kjøring',
    'bun generate/scan-stories.ts --proofread --book 41              # bare marker, ingen skriving',
    '',
...
async function main(): Promise<void> {
    ...
    if (flags.help) {
        console.log(formatHelp('generate/scan-stories.ts', HELP_PURPOSE, SPEC, HELP_EXAMPLES));
        process.exit(0);
    }
