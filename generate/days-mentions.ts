...
const SCRIPT = 'generate/days-mentions.ts';
...
const EXAMPLES = [
    'bun generate/days-mentions.ts --bible osnb --book 40 --chapter 12',
    'bun generate/days-mentions.ts --bible osnb --book 40',
    'bun generate/days-mentions.ts --bible osnb --nt',
    'bun generate/days-mentions.ts --bible osnb',
];
