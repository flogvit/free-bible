 ...
 *
 *   bun generate/build-translations-meta.ts                     # all translations missing meta.json
 *   bun generate/build-translations-meta.ts --only kjv,geneva   # named translations
 *   bun generate/build-translations-meta.ts --force             # regenerate existing
 *   bun generate/build-translations-meta.ts --recount           # refresh coverage only, no LLM
 *   bun generate/build-translations-meta.ts --no-web            # pass 1 only (cheap dry run)
 */
...
const HELP_EXAMPLES = [
    'bun generate/build-translations-meta.ts                     # alle uten meta.json',
    'bun generate/build-translations-meta.ts --only kjv,geneva   # navngitte oversettelser',
    'bun generate/build-translations-meta.ts --force             # lag på nytt selv om fila finnes',
    'bun generate/build-translations-meta.ts --recount           # bare nye tall, ingen modellkall',
    'bun generate/build-translations-meta.ts --no-web            # bare pass 1',
];
