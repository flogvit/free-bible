...
const HELP_EXAMPLES = [
    'bun generate/chapter-tags.ts --bible osnb --book 1                # tagg 1. Mosebok',
    'bun generate/chapter-tags.ts --bible osnb --nt --local            # tagg NT med lokal Ollama',
    'bun generate/chapter-tags.ts --bible osnb --book 19 --chapter 23  # tagg Salme 23',
    'bun generate/chapter-tags.ts --bible osnb --force                 # tagg alt på nytt',
    '',
