...
const HELP_EXAMPLES = [
    'bun generate/verse-translation.ts osnb --book 1 --chapter 1   # 1. Mosebok 1',
    'bun generate/verse-translation.ts osnb --book 43              # hele Johannes',
    'bun generate/verse-translation.ts osnb --nt                   # hele NT',
    'bun generate/verse-translation.ts osnn --book 1 --force       # generer på nytt',
    'bun generate/verse-translation.ts osnb --book 1-20 &          # parallelt, terminal 1',
    'bun generate/verse-translation.ts osnb --book 21-39 &         # parallelt, terminal 2',
    '',
...
async function main(): Promise<void> {
    ...
    const options: Options = {
        // Bibelen er posisjonsargumentet, som før: `bun generate/verse-translation.ts osnb`.
