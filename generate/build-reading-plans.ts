 ...
 *
 * Run with: bun build-reading-plans.ts
 *
...
import { planDefinitions, categoryOrder } from './reading-plans-config.js';
...
/**
 * En plandefinisjon fra reading-plans-config.js.
 *
...
function main(): void {
  ...
  if (flags.help) {
    console.log(formatHelp(
      ...
      'genererer alle leseplanene fra reading-plans-config.ts og SKRIVER dem til '
